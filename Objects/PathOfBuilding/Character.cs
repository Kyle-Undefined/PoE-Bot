namespace PoE.Bot.Objects.PathOfBuilding
{
    ...
    {
        public Character(int level, string characterClass, string ascendancy, Summary summary, MinionSummary minionSummary, CharacterSkills skills, string tree, int auraCount, int curseCount, string config, IEnumerable<ItemSlots> itemSlots, IEnumerable<Items> items)
        {
