namespace PoE.Bot.Services
{
    ...
    public class LeaderboardService
    {
        ...
        private Embed BuildDiscordOnlyEmbed(string leaderboard)
        {
        ...
        private Embed BuildTopClassEmbed(string leaderboard)
        {
            var sb = new StringBuilder();
            var embed = EmbedHelper.Embed(EmbedHelper.Leaderboard)
        ...
        private async Task GetLeaderboardDataAsync(string console, string variant)
        {
            using (var response = await _httpClient.GetAsync("https://www.pathofexile.com/public/ladder/Path_of_Exile_" + console + "_" + variant + "_league_export.csv", HttpCompletionOption.ResponseHeadersRead).ConfigureAwait(false))
            {
